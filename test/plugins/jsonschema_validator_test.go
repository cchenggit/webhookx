	...
	Context("sanity", func() {
		...
		entitiesConfig.Plugins = []*entities.Plugin{
			factory.PluginP(
				...
				factory.WithPluginConfig(schema_validator.Config{
					EventSchemas: []*schema_validator.EventTypeSchema{
						{
							EventType:  "charge.succeeded",
							JSONSchema: []byte(eventSchemaDef),
						},
					},
				}),
			),
		...
		It("sanity event if undeclared event type", func() {
